...
describe "true" do 
  ...
  describe "'&&'" do 
    it "should evaluate it's argument" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string("x=41. true &&(x=42). x").data.as_java_integer.should == 42
    end

    it "should complain if no argument is given" do 
      ioke = IokeRuntime.get_runtime
      proc do 
        ioke.evaluate_string("true &&()")
      end.should raise_error
    end

    it "should return the result of the argument" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string("true &&(42)").data.as_java_integer.should == 42
    end

    it "should be available in infix" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string("true && 43").data.as_java_integer.should == 43
    end
  end
  ...
  describe "'||'" do 
    it "should not evaluate it's argument" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string("x=41. true ||(x=42). x").data.as_java_integer.should == 41
    end

    it "should return true" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string("true ||(42)").should == ioke.true
    end

    it "should be available in infix" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string("true || 43").should == ioke.true
    end
  end
...
describe "false" do 
  ...
  describe "'&&'" do 
    it "should not evaluate it's argument" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string("x=41. false &&(x=42). x").data.as_java_integer.should == 41
    end

    it "should return false" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string("false &&(42)").should == ioke.false
    end

    it "should be available in infix" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string("false && 43").should == ioke.false
    end
  end
  ...
  describe "'||'" do 
    it "should evaluate it's argument" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string("x=41. false ||(x=42). x").data.as_java_integer.should == 42
    end

    it "should complain if no argument is given" do 
      ioke = IokeRuntime.get_runtime
      proc do 
        ioke.evaluate_string("false ||()")
      end.should raise_error
    end

    it "should return the result of the argument" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string("false ||(42)").data.as_java_integer.should == 42
    end

    it "should be available in infix" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string("false || 43").data.as_java_integer.should == 43
    end
  end
