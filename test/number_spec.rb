...
describe "Number" do 
  ...
  describe "Real" do 
    it "should have the correct kind" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string('Number Real kind == "Number Real"').should == ioke.true
    end

    it "should mimic Number" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string('Number Real mimics?(Number)').should == ioke.true
    end
  end
  ...
  describe "Rational" do 
    it "should have the correct kind" do 
      ioke = IokeRuntime.get_runtime
      ioke.evaluate_string('Number Rational kind == "Number Rational"').should == ioke.true
    end
