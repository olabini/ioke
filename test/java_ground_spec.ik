...
describe("Java Objects",
  ...
  describe("static methods",
    ...
    it("should be possible to coerce into a short argument")
    it("should be possible to coerce into an int argument")
    it("should be possible to coerce into a char argument")
    it("should be possible to coerce into a long argument")
    it("should be possible to coerce into a float argument")
    it("should be possible to coerce into a double argument")
