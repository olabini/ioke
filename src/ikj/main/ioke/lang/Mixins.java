...
public class Mixins {
    public static void init(IokeObject mixins) throws ControlFlow {
        ...
        mixins.setCell("=",         mixins.runtime.base.body.get("=", 0));
        mixins.setCell("==",        mixins.runtime.base.body.get("==", 0));
        mixins.setCell("cell",      mixins.runtime.base.body.get("cell", 0));
        mixins.setCell("cell=",     mixins.runtime.base.body.get("cell=", 0));
        mixins.setCell("cell?",     mixins.runtime.base.body.get("cell?", 0));
        mixins.setCell("cells",     mixins.runtime.base.body.get("cells", 0));
        mixins.setCell("cellNames", mixins.runtime.base.body.get("cellNames", 0));
        mixins.setCell("mimic",     mixins.runtime.base.body.get("mimic", 0));
